    ...
    public SecurityFilterChain filterChain(HttpSecurity http,
        ...
        http
            ...
            .exceptionHandling(ex -> ex
                    .authenticationEntryPoint((req, res, e) -> write(
                            res, objectMapper, HttpStatus.UNAUTHORIZED,
                            ErrorCode.UNAUTHORIZED, "Authentication required"))
                    .accessDeniedHandler((req, res, e) -> write(
                            res, objectMapper, HttpStatus.FORBIDDEN,
